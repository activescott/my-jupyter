...
rm -rf /jovyan/.cache/pip/*
# Delete old downloaded archive files 
sudo apt-get autoremove -y
# Delete downloaded archive files
sudo apt-get clean
# list of packages will get downloaded from the Ubuntu servers (can be large https://askubuntu.com/questions/179955/var-lib-apt-lists-is-huge)
